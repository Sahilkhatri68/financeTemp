      ...
      <div class="container">
        <div class="row">
          ...
          <div class="" style="width:50%">
            <ul class="right-icons" style="width:100% !important;">
              <!-- <li><a href="#"><i class="fa fa-facebook"></i></a></li>
              <li><a href="#"><i class="fa fa-twitter"></i></a></li>
              <li><a href="#"><i class="fa fa-linkedin"></i></a></li>
              <li><a href="#"><i class="fa fa-behance"></i></a></li> -->
              <marquee><span style="font-weight:500;color:white; font-size: 19px;">Latest information about meetings will be displayed here</span></marquee>
            </ul>
          </div>
        </div>
      </div>
